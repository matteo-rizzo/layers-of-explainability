...
class EmotionLex(Feature):
    ...
    def label_description(cls) -> dict[str, str]:
        labels = ['EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_anger_avgLexVal', 'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_anticipation_avgLexVal',
                  'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_disgust_avgLexVal', 'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_fear_avgLexVal',
                  'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_joy_avgLexVal', 'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_negative_avgLexVal',
                  'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_positive_avgLexVal', 'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_sadness_avgLexVal',
                  'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_surprise_avgLexVal', 'EmotionLex_NRC-Emotion-Lexicon-Wordlevel-v0.92_trust_avgLexVal',
                  'EmotionLex_NRC-VAD-Lexicon_valence_avgLexVal', 'EmotionLex_NRC-VAD-Lexicon_arousal_avgLexVal', 'EmotionLex_NRC-VAD-Lexicon_domination_avgLexVal',
                  'EmotionLex_NRC-Hashtag-Emotion-Lexicon-v0.2_anger_avgLexVal', 'EmotionLex_NRC-Hashtag-Emotion-Lexicon-v0.2_anticipation_avgLexVal',
