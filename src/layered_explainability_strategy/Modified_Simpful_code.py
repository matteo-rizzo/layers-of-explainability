...
FS.set_output_function('fun1', '6.208649e-01*offensive+3.345043e-01*female+1.752369e-01*TextEmotion_anger+-5.237787e-02*subjectivity+-4.577606e-02*GibberishDetector_clean+9.929635e-02*sarcasm+-8.772847e-02*word_count+-1.158139e-02*irony+-1.000347e-01')
FS.set_output_function('fun2', '5.898416e-01*offensive+3.326967e-01*female+1.871315e-01*TextEmotion_anger+-5.280500e-02*subjectivity+-4.455483e-02*GibberishDetector_clean+9.747353e-02*sarcasm+-8.322537e-02*word_count+-1.247330e-02*irony+-8.274593e-02')
...
MF_GibberishDetector_clean = LinguisticVariable([FS_9, FS_10], concept='GibberishDetector_clean', universe_of_discourse=u_o_d)
